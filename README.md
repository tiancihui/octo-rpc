...
目前美团内部服务使用的Mtransport通信框架体系是在facebook开源的thrift上持续开发，逐步满足公司内部业务场景需求
...
## 介绍 ##
  对业务开发者, MTransport 屏蔽了底层网络通信细节, 从而更专注于业务自身逻辑实现实现. 
 支持不同语言版本的代码实现, 保持通信协议的一致性，支持服务注册、服务自动发现、client端异步、负载均衡等相关功能。
